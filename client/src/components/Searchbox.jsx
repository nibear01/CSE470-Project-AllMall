...
const Searchbox = () => {
  return (
    <div className="relative w-full max-w-[500px]">
      <div className="flex items-center h-[50px] bg-[#dfdfdf9c] rounded-lg overflow-hidden shadow-sm transition-all duration-300 hover:shadow-md focus-within:shadow-lg focus-within:ring-2 focus-within:ring-emerald-600">
        <input
