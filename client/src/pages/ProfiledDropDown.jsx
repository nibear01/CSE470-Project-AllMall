...
const ProfileDropdown = () => {
  ...
  return (
    <div ref={dropdownRef} className="!relative">
      ...
      {/* Dropdown Menu */}
      <div
        className={`!absolute !right-0 !z-50 !mt-2 !w-48 !bg-white !border !border-gray-200 !rounded-md !shadow-lg !overflow-hidden !transition-all !duration-300 !ease-in-out ${isOpen ? '!opacity-100 !scale-100 !translate-y-0' : '!opacity-0 !scale-95 !-translate-y-2 !pointer-events-none'}`}
      >
        {isOpen && (
          <ul className="!py-1">
